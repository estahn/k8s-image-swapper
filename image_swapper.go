...
func (p *ImageSwapper) Mutate(ctx context.Context, obj metav1.Object) (bool, error) {
	...
	for i := range pod.Spec.Containers {
		...
		//skopeo copy docker://docker.io/library/redis:latest docker://855460960717.dkr.ecr.ap-southeast-2.amazonaws.com/foobar/enrico:redislatest --dest-creds AWS:$(aws ecr get-login-password --output text) --src-no-creds
